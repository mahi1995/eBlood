<%@ Page Title="change Password" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeFile="chnPasswordadmin.aspx.cs" Inherits="ChnPasswordAdmin" %>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    ...
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Passwords doesn't Match" CultureInvariantValues="True" />
                                </div>
                            </div>      
                        </div>
